...
{   
    ...
    public class OsmTreeConnector
    {
        ...
        public static void addOsmConnection(String idFilteredTree, String idBrailleTree, ref List<OsmTreeConnectorTuple<String, String>> osmConnection)
        {   //TODO: evtl. noch prüfen, ob die Ids existieren
            ...
            {
                OsmTreeConnectorTuple<String, String> relationship = new OsmTreeConnectorTuple<String, String>();
        ...
        /// <param name="idBrailleTree">id of the braille node</param>
        /// <param name="osmConnection">(previous) OSM connections</param>
        public static void setOsmConnection(String idFilteredTree, String idBrailleTree, ref List<OsmTreeConnectorTuple<String, String>> osmConnection)
        {
            if (idFilteredTree == null || idBrailleTree == null) { Debug.WriteLine("One of the ids dosn't exist! The relationship wasn't set."); return; }
        ...
        /// <param name="idBrailleTree">id of the braille node</param>
        /// <param name="osmConnection">(previous) OSM connections</param>
        public static void removeOsmConnection(String idFilteredTree, String idBrailleTree, ref List<OsmTreeConnectorTuple<String, String>> osmConnection)
        {
            if (osmConnection.Exists(r => r.BrailleTree.Equals(idBrailleTree) && r.FilteredTree.Equals(idFilteredTree)))
            {
                OsmTreeConnectorTuple<String, String> relationshipToRemove = osmConnection.Find(r => r.BrailleTree.Equals(idBrailleTree) && r.FilteredTree.Equals(idFilteredTree));
