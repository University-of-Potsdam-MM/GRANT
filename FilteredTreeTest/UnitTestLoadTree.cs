...
namespace FilteredTreeTest
{
    ...
    public class UnitTestLoadTree
    {
        ...
        {
            guiFuctions.loadGrantProject(@projectPath);
        ...
        private bool compareToNodes(object node1, object node2)
        {
            ...
            if (osmNode1.properties.fileName != null && !osmNode1.properties.fileName.Equals(osmNode2.properties.fileName)) { Assert.Fail("Der fileName der beiden Knoten stimmt nicht überein!\n node1 = {0}\n node2 = {1}", strategyMgr.getSpecifiedTree().GetData(node1), strategyMgr.getSpecifiedTree().GetData(node2)); return false; }
