...
namespace TactileWeb.UIA
{
    ...
    [ComVisible(true), ComImport, Guid("34723aff-0c9d-49d0-9896-7ab52df8cd8a"),  InterfaceType( ComInterfaceType.InterfaceIsIUnknown )]
    public interface IUIAutomation2
    {
        ...
        // https://msdn.microsoft.com/en-us/library/windows/desktop/hh437194(v=vs.85).aspx
        // UIAutomationClient.h  Zeile 12448

        [PreserveSig]  int get_AutoSetFocus     (out bool autoSetFocus);
        //virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_AutoSetFocus( 
        //    /* [retval][out] */ __RPC__out BOOL *autoSetFocus) = 0;

        [PreserveSig]  int put_AutoSetFocus     (bool autoSetFocus);
        //virtual /* [propput] */ HRESULT STDMETHODCALLTYPE put_AutoSetFocus( 
        //    /* [in] */ BOOL autoSetFocus) = 0;



        [PreserveSig]  int get_ConnectionTimeout     (out int timeout);
        //virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_ConnectionTimeout( 
        //    /* [retval][out] */ __RPC__out DWORD *timeout) = 0;

        [PreserveSig]  int put_ConnectionTimeout     (int timeout);
        //virtual /* [propput] */ HRESULT STDMETHODCALLTYPE put_ConnectionTimeout( 
        //    /* [in] */ DWORD timeout) = 0;



        [PreserveSig]  int get_TransactionTimeout     (out int timeout);
        //virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_TransactionTimeout( 
        //    /* [retval][out] */ __RPC__out DWORD *timeout) = 0;

        [PreserveSig]  int put_TransactionTimeout     (int timeout);
